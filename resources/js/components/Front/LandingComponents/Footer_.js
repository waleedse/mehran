        ...
        <div className="mob_center row footerRow">
          ...
          <div className="col-md-2 col-sm-4">
            <div className="footerCol">
              ...
              <a href="/faqs" style={{color:"gray"}}><h5 className="  footerItemText">FAQ's</h5></a>
              <a href="/TermsAndconditions" style={{color:"gray"}}><h5 className="  footersmalltext footerItemText">Terms and Condition</h5></a>
              <a href="/PrivacyPolicy" style={{color:"gray"}}><h5 className="  footersmalltext footerItemText">Privacy Policy</h5></a>
              <a href="/distributor" style={{color:"gray"}}><h5 className=" footersmalltext footerItemText">Distributors</h5></a>
