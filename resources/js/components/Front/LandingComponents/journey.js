      ...
      <div className="container">
        <div className=" row journeyBox">
          ...
          <div className="col-lg-6 col-md-12 col-sm-12">
            {" "}
            <h1 className="title-text mt-5">Your Most Comfortable</h1>
            <hi className="title-text">
              <span className="redDivider">Jour</span>ney Begins Here
            </hi>
            <p className="text-secondary justify-content mt-5">
