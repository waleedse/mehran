...
class Products extends Component {
    ...
    componentDidMount(){
        setTimeout(()=>{
            ...
            Axios.post(baseurl+'/api/get_dis_product_enabled_by_id',senderdata).then(res=>{
                console.log(res);
                this.setState({
                    loading:false
                })
    ...
    add_product_in_cart(){
        ...
        if(cart_cookie_id == null){
            window.localStorage.setItem('dis_cart_cookie_id',uuidv1())
        }
                    ...
                    <div className="container-fluid p-3">
                        <div className="wrapper row">
                            ...
                            {/* <h3 className="product-title">{this.state.product.name}</h3> */}
                                ...
                                <select style={{height:'33px',width:'180px'}} onChange={this.onchange_varient.bind(this)} value={this.state.varient_id} className="form-control col-md-2 ml-3">
