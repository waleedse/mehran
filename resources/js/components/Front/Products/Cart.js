                    ...
                    this.state.loading ?
                        ...
                        :
                         ...
                         this.state.cart.length == 0 ?
                                <div className="container-fluid mt-5 no_data">
                                    <img src={img_baseurl+"cartempty.png"}></img>
                                        ...
                                        <div className="ibox">
                                            ...
                                            <div className="ibox-content">
                                                ...
                                                <div className="m-t-sm">
                                                    ...
                                                    <a href="/Checkout" className="btn btn-success btn-sm"><i className="fa fa-shopping-cart"></i> Checkout</a>
