...
class RetailCustomerOrders extends Component {
    constructor(props) {
        super(props);
        this.state={
            enddate:new Date(),
    ...
    search_sales(){
        ...
        Axios.post('/api/search_Customer_Orders',senderdata).then(res=>{
    ...
    print_report(){
        ...
        Axios.post('/api/print_customer_orders_report',senderdata,{
            responseType: 'blob'
        }).then(response=>{
            const file = new Blob(
                [response.data], 
        ...
        return (
            <div>
                <div className="top_section_title_div">
                    <h2 className="section_title">Retail Customer Orders Report</h2>
                </div>
...
export default RetailCustomerOrders;